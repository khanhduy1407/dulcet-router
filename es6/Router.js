...
var Router = Dulcet.createClass({
  ...
  getDefaultProps: function getDefaultProps() {
    return {
      render: function render(props) {
        return Dulcet.createElement(RouterContext, props);
      }
    };
  },
  ...
  wrapDeprecatedHistory: function wrapDeprecatedHistory(history) {
    ...
    if (history) {
      ...
      process.env.NODE_ENV !== 'production' ? warning(false, '`Router` no longer defaults the history prop to hash history. Please use the `hashHistory` singleton instead.') : undefined;
