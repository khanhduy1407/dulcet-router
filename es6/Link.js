...
var Link = Dulcet.createClass({
  ...
  render: function render() {
    ...
    process.env.NODE_ENV !== 'production' ? warning(!(query || hash || state), 'the `query`, `hash`, and `state` props on `<Link>` are deprecated, use `<Link to={{ pathname, query, hash, state }}/>.') : undefined;
    ...
    return Dulcet.createElement('a', _extends({}, props, { onClick: this.handleClick }));
  }
