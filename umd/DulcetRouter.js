(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("dulcet"));
	else if(typeof define === 'function' && define.amd)
		define(["dulcet"], factory);
	else if(typeof exports === 'object')
		exports["DulcetRouter"] = factory(require("dulcet"));
	else
		root["DulcetRouter"] = factory(root["Dulcet"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dulcet = __webpack_require__(2);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var array = _Dulcet$PropTypes.array;
	var func = _Dulcet$PropTypes.func;
	var object = _Dulcet$PropTypes.object;
	 ...
	 */
	var RouterContext = _dulcet2['default'].createClass({
	  ...
	  getDefaultProps: function getDefaultProps() {
	    return {
	      createElement: _dulcet2['default'].createElement
	    };
	  },
	  ...
	  getChildContext: function getChildContext() {
	    ...
	    if (false) {
	      location = _deprecateObjectProperties2['default'](location, '`context.location` is deprecated, please use a route component\'s `props.location` instead.');
	    }
	  ...
	  render: function render() {
	    ...
	    if (components) {
	      element = components.reduceRight(function (element, components, index) {
	        ...
	        if (_RouteUtils.isDulcetChildren(element)) {
	    ...
	    !(element === null || element === false || _dulcet2['default'].isValidElement(element)) ?  false ? _invariant2['default'](false, 'The root route must render a single element') : _invariant2['default'](false) : undefined;
	...
	function createTransitionManager(history, routes) {
	  ...
	  function isActive(location) {
	    ...
	    if (indexOnlyOrDeprecatedQuery && indexOnlyOrDeprecatedQuery !== true || deprecatedIndexOnly !== null) {
	       false ? _routerWarning2['default'](false, '`isActive(pathname, query, indexOnly) is deprecated; use `isActive(location, indexOnly)` with a location descriptor instead.') : undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Dulcet$PropTypes = _dulcet2['default'].PropTypes;
	var bool = _Dulcet$PropTypes.bool;
	var object = _Dulcet$PropTypes.object;
	var string = _Dulcet$PropTypes.string;
	var func = _Dulcet$PropTypes.func;
	var oneOfType = _Dulcet$PropTypes.oneOfType;
	 ...
	 */
	var Link = _dulcet2['default'].createClass({
	  displayName: 'Link',
	  ...
	  render: function render() {
	    ...
	    var props = _objectWithoutProperties(_props2, ['to', 'query', 'hash', 'state', 'activeClassName', 'activeStyle', 'onlyActiveOnIndex']);
	     ...
	     false ? _routerWarning2['default'](!(query || hash || state), 'the `query`, `hash`, and `state` props on `<Link>` are deprecated, use `<Link to={{ pathname, query, hash, state }}/>.') : undefined;
	    ...
	    return _dulcet2['default'].createElement('a', _extends({}, props, { onClick: this.handleClick }));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createRoutingHistory(history, transitionManager) {
	  ...
	  if (false) {
	    history = _deprecateObjectProperties2['default'](history, '`props.history` and `context.history` are deprecated. Please use `context.router`.');
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var History = {
	  ...
	  componentWillMount: function componentWillMount() {
	     false ? _routerWarning2['default'](false, 'the `History` mixin is deprecated, please access `context.router` with your own `contextTypes`.') : undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Lifecycle = {
	  ...
	  componentDidMount: function componentDidMount() {
	     false ? _routerWarning2['default'](false, 'the `Lifecycle` mixin is deprecated, please use `context.router.setRouteLeaveHook(route, hook)`.') : undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RouteContext = {
	  ...
	  componentWillMount: function componentWillMount() {
	     false ? _routerWarning2['default'](false, 'The `RouteContext` mixin is deprecated. You can provide `this.props.route` on context with your own `contextTypes`.') : undefined;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var Router = _dulcet2['default'].createClass({
	  displayName: 'Router',
	  ...
	  getDefaultProps: function getDefaultProps() {
	    return {
	      render: function render(props) {
	        return _dulcet2['default'].createElement(_RouterContext2['default'], props);
	      }
	    };
	  },
	  ...
	  componentWillMount: function componentWillMount() {
	    ...
	    var stringifyQuery = _props.stringifyQuery;
	     ...
	     false ? _routerWarning2['default'](!(parseQueryString || stringifyQuery), '`parseQueryString` and `stringifyQuery` are deprecated. Please create a custom history.') : undefined;
	  ...
	  wrapDeprecatedHistory: function wrapDeprecatedHistory(history) {
	    ...
	    if (history) {
	       false ? _routerWarning2['default'](false, 'It appears you have provided a deprecated history object to `<Router/>`, please use a history provided by ' + 'Dulcet Router with `import { browserHistory } from \'dulcet-router\'` or `import { hashHistory } from \'dulcet-router\'`. ' + 'If you are using a custom history please create it with `useRouterHistory`.') : undefined;
	      createHistory = function () {
	        return history;
	      };
	    } else {
	       false ? _routerWarning2['default'](false, '`Router` no longer defaults the history prop to hash history. Please use the `hashHistory` singleton instead.') : undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RoutingContext = _dulcet2['default'].createClass({
	  ...
	  componentWillMount: function componentWillMount() {
	     false ? _routerWarning2['default'](false, '`RoutingContext` has been renamed to `RouterContext`. Please use `import { RouterContext } from \'dulcet-router\'`.') : undefined;
	  },
	...
	function runEnterHooks(routes, nextState, callback) {
	  ...
	  function replace(location, deprecatedPathname, deprecatedQuery) {
	    if (deprecatedPathname) {
	       false ? _routerWarning2['default'](false, '`replaceState(state, pathname, query) is deprecated; use `replace(location)` with a location descriptor instead.') : undefined;
	      redirectInfo = {
